...
using ApiCore.Application.Features.Positions.Commands.DeletePositionById;
using ApiCore.Application.Features.Positions.Commands.UpdatePosition;
using ApiCore.Application.Features.Positions.Queries.GetPositionById;
...
namespace ApiCore.WebApi.Controllers.v1
{
    [ApiVersion("1.0")]
